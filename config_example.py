# Copy this file and rename it to config.py, then fill in your values
# Or directly edit the values in osint_bot.py
...
# Channel usernames (must be public, bot must be admin)
CHANNEL_1 = "@your_channel_1"  # Replace with first channel username
